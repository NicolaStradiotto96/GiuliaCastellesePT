<x-layout>
    ...
    {{-- SECTION 1 --}}
    <section class="home-section-1 w-screen h-screen bg-b">
        <h2 class="font-title text-white text-center text-6xl pt-10">PIANO PERSONALIZZATO</h2>
    ...
    {{-- SECTION 2 --}}
    <section class="home-section-2 w-screen h-screen" style="background-image: url('{{ asset('scroll.jpg') }}');">
    </section>
