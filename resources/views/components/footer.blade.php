<footer class="section footer sm:footer-horizontal w-screen h-screen bg-b p-10 text-white overflow-hidden flex flex-col"
    id="contatti">
    <h1 class="font-title section-title text-center pt-15 px-5">CHE ASPETTI? INIZIA ORA!</h1>
    <div>
        <h6 class="footer-title text-center">Seguimi su</h6>
